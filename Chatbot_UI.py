...
import json
import random
intents = json.loads(open('D:\Academics\Projects\Impala Chatbot\intents.json').read())
words = pickle.load(open('D:\Academics\Projects\Impala Chatbot\word_data.pkl','rb'))
classes = pickle.load(open('D:\Academics\Projects\Impala Chatbot\class_data.pkl','rb'))
